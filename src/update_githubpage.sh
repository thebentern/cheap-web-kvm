...
# Remove old files in destination (except .git and hand-written docs that live
# in docs/ rather than src/www/ - PROTOCOL.md is not part of the served UI).
echo "Cleaning destination directory..."
find "$DEST_DIR" -mindepth 1 -maxdepth 1 ! -name '.git' ! -name 'PROTOCOL.md' -exec rm -rf {} +
